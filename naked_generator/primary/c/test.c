...
/* primary_SET_ACCELERATOR_RANGE */
    ...
    primary_SET_ACCELERATOR_RANGE primary_set_accelerator_range_s = { 86 };
...
/* primary_PEDALS_ADC_RANGES */
    ...
    primary_PEDALS_ADC_RANGES primary_pedals_adc_ranges_s = { 23459.0, 5401.0, 38536.0, 23597.0 };
...
/* primary_ACCELERATOR_PEDAL_VAL */
    ...
    primary_ACCELERATOR_PEDAL_VAL primary_accelerator_pedal_val_s = { 55.0 };
...
/* primary_BRAKE_PEDAL_VAL */
    ...
    primary_BRAKE_PEDAL_VAL primary_brake_pedal_val_s = { 220.0 };
...
/* primary_PCU_STATUS */
    ...
    primary_PCU_STATUS primary_pcu_status_s = { {212}, {94} };
...
/* primary_TIMESTAMP */
    ...
    primary_TIMESTAMP primary_timestamp_s = { 853196820.0 };
...
/* primary_TLM_STATUS */
    ...
    primary_TLM_STATUS primary_tlm_status_s = { -54, 99, 239.0, 169.0 };
...
/* primary_CAR_STATUS */
    ...
    primary_CAR_STATUS primary_car_status_s = { -67, 84, -109 };
...
/* primary_SET_TLM_STATUS */
    ...
    primary_SET_TLM_STATUS primary_set_tlm_status_s = { 13, -38, 229.0, 21.0 };
...
/* primary_GPS_COORDS */
    ...
    primary_GPS_COORDS primary_gps_coords_s = { 1509907952.356, 233460379.234 };
...
/* primary_GPS_SPEED */
    ...
    primary_GPS_SPEED primary_gps_speed_s = { 19503.0 };
...
/* primary_HV_VOLTAGE */
    ...
    primary_HV_VOLTAGE primary_hv_voltage_s = { 4846.0, 10468.0, 18557.0, 47516.0 };
...
/* primary_HV_CURRENT */
    ...
    primary_HV_CURRENT primary_hv_current_s = { 40440.0, 61.0 };
...
/* primary_HV_TEMP */
    ...
    primary_HV_TEMP primary_hv_temp_s = { 33920.0, 46858.0, 34417.0 };
