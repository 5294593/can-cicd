...
/* primary_SET_ACCELERATOR_RANGE */
    ...
    primary_SET_ACCELERATOR_RANGE primary_set_accelerator_range_s = { 119 };
...
/* primary_PEDALS_ADC_RANGES */
    ...
    primary_PEDALS_ADC_RANGES primary_pedals_adc_ranges_s = { 30021.0, 59738.0, 48986.0, 50563.0 };
...
/* primary_ACCELERATOR_PEDAL_VAL */
    ...
    primary_ACCELERATOR_PEDAL_VAL primary_accelerator_pedal_val_s = { 181.0 };
...
/* primary_BRAKE_PEDAL_VAL */
    ...
    primary_BRAKE_PEDAL_VAL primary_brake_pedal_val_s = { 254.0 };
...
/* primary_PCU_STATUS */
    ...
    primary_PCU_STATUS primary_pcu_status_s = { {232}, {140} };
...
/* primary_TIMESTAMP */
    ...
    primary_TIMESTAMP primary_timestamp_s = { 150515295.0 };
...
/* primary_TLM_STATUS */
    ...
    primary_TLM_STATUS primary_tlm_status_s = { -44, -99, 171.0, 195.0 };
...
/* primary_CAR_STATUS */
    ...
    primary_CAR_STATUS primary_car_status_s = { 74, 52, 87 };
...
/* primary_SET_TLM_STATUS */
    ...
    primary_SET_TLM_STATUS primary_set_tlm_status_s = { -125, 12, 97.0, 235.0 };
...
/* primary_GPS_COORDS */
    ...
    primary_GPS_COORDS primary_gps_coords_s = { -1382117088.648, 1395137195.137 };
...
/* primary_GPS_SPEED */
    ...
    primary_GPS_SPEED primary_gps_speed_s = { 27110.0 };
...
/* primary_HV_VOLTAGE */
    ...
    primary_HV_VOLTAGE primary_hv_voltage_s = { 46067.0, 32474.0, 19164.0, 27432.0 };
...
/* primary_HV_CURRENT */
    ...
    primary_HV_CURRENT primary_hv_current_s = { 55646.0, -229.0 };
...
/* primary_HV_TEMP */
    ...
    primary_HV_TEMP primary_hv_temp_s = { 32660.0, 1775.0, 4006.0 };
...
/* primary_HV_ERRORS */
    ...
    primary_HV_ERRORS primary_hv_errors_s = { {20, 132}, {251, 97} };
...
/* primary_TS_STATUS */
    ...
    primary_TS_STATUS primary_ts_status_s = { 35 };
...
/* primary_SET_TS_STATUS */
    ...
    primary_SET_TS_STATUS primary_set_ts_status_s = { 77 };
...
/* primary_STEER_STATUS */
    ...
    primary_STEER_STATUS primary_steer_status_s = { -33, -40, 0.0 };
...
/* primary_SET_CAR_STATUS */
    ...
    primary_SET_CAR_STATUS primary_set_car_status_s = { -46 };
...
/* primary_LV_CURRENT */
    ...
    primary_LV_CURRENT primary_lv_current_s = { 33.0 };
...
/* primary_LV_VOLTAGE */
    ...
    primary_LV_VOLTAGE primary_lv_voltage_s = { 64.0, 99.0, 116.0, 230.0, 6308.0 };
...
/* primary_LV_TEMPERATURE */
    ...
    primary_LV_TEMPERATURE primary_lv_temperature_s = { 42.0, 0, 42718.0 };
...
/* primary_COOLING_STATUS */
    ...
    primary_COOLING_STATUS primary_cooling_status_s = { 33.0, 219.0, 118.0 };
...
/* primary_HV_CELLS_VOLTAGE */
    ...
    primary_HV_CELLS_VOLTAGE primary_hv_cells_voltage_s = { 184.0, 0, 42851.0, 861.0, 22272.0 };
...
/* primary_HV_CELLS_TEMP */
    ...
    primary_HV_CELLS_TEMP primary_hv_cells_temp_s = { 10.0, 124.0, 34.0, 172.0, 36.0, 173.0, 63.0, 4.0 };
...
/* primary_SET_CHG_POWER */
    ...
    primary_SET_CHG_POWER primary_set_chg_power_s = { 5488.0, 36691.0 };
...
/* primary_CHG_STATUS */
    ...
    primary_CHG_STATUS primary_chg_status_s = { 69 };
...
/* primary_SET_CHG_STATUS */
    ...
    primary_SET_CHG_STATUS primary_set_chg_status_s = { -127 };
...
/* primary_CHG_SETTINGS */
    ...
    primary_CHG_SETTINGS primary_chg_settings_s = { 219.0 };
